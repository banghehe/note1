...
function Video(logContainer)
{
	if (navigator.userAgent.search("MSIE") >= 0) {
	    this.icelinkServerAddress = '117.6.131.222:3478';
    	this.websyncServerUrl = 'http://171.244.38.99:8089/websync.ashx'; // WebSync On-Demand
	}
...
Video.prototype.startConference = function(callback)
{
    ...
    this.conference.setRelayUsername('server');
    this.conference.setRelayPassword('Giacngo79');
